  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex space-x-4 border-b">
        <button onClick={() => setActiveTab('posts')} className={`px-4 py-2 ${activeTab === 'posts' ? 'border-b-2 border-secondary' : ''}`}>Posts</button>
        <button onClick={() => setActiveTab('resume')} className={`px-4 py-2 ${activeTab === 'resume' ? 'border-b-2 border-secondary' : ''}`}>Resume</button>
      </div>
